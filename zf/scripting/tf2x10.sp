...
public Action Timer_ServerRunningX10(Handle hTimer)
{
	...
	PrintToChatAll("\x01[\x07FF0000日常服务器\x01] 指令(打开聊天窗输入这些命令)如下:");
	PrintToChatAll("\x01[\x07FF0000日常服务器\x01] !3:切换成第三人称!1切换成第一人称");
	PrintToChatAll("\x01[\x07FF0000日常服务器\x01] rtd:随机效果");
	PrintToChatAll("\x01[\x07FF0000日常服务器\x01] !s:打开商店 ");
	PrintToChatAll("\x01[\x07FF0000日常服务器\x01] !taunt:嘲讽");
	PrintToChatAll("\x01[\x07FF0000日常服务器\x01] /pay:捐助(5元永久vip)");
	PrintToChatAll("\x01[\x07FF0000日常服务器\x01] 喷气背包按~(打开控制台 不是在聊天窗输入)输入bind shift +jetpack 后 按shift就可以飞了 ");
