...
#define UPDATE_URL "http://giovani_nescau.bitbucket.org/powerups_shop/ps_update.txt"
...
public void OnPluginStart()
{
	...
	//ConVars
	CreateConVar("powerups_version", PLUGIN_VERSION, "Powerups Shop version.", FCVAR_PLUGIN | FCVAR_NOTIFY);
