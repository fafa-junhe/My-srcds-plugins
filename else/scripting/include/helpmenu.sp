...
public OnPluginStart() {
	...
	g_cvarWelcome = CreateConVar("sm_helpmenu_welcome", "0", "Show welcome message to newly connected users.", FCVAR_PLUGIN);
	g_cvarAdmins = CreateConVar("sm_helpmenu_admins", "0", "Show a list of online admins in the menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_vip", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
