...
*	Link	:	http://forums.alliedmods.net/showthread.php?t=306473
...
public Plugin myinfo =
{
	...
	url = "http://forums.alliedmods.net/showthread.php?t=306473"
}
...
public void OnPluginStart()
{
	...
	CreateConVar(				"private_trigger_version",		PLUGIN_VERSION,		"Private Trigger Log version.", FCVAR_NOTIFY);
...
public Action OnClientSayCommand(int client, const char[] command, const char[] sArgs)
{
	...
	{
		if (sArgs[0] == SilentChatTriggers[i])
		{
			pass = true;
			break;
		}
...
public SMCResult Config_KeyValue(Handle parser, char[] key, char[] value, bool key_quotes, bool value_quotes)
{
	...
	if(StrEqual(key, "SilentChatTrigger", false))
	{
