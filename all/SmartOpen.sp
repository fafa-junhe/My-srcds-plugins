...
{
	if(GetClientTeam(client) != CS_TEAM_CT && !CheckCommandAccess(client, "sm_open_override", ADMFLAG_SLAY, false))
	{
	...
	PrintToChatAll("\x01Warden\x03 %N\x04 opened\x01 the\x05 jail cells!", client);
	return Plugin_Handled;
}
